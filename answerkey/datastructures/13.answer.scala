...
function as we've done in this chapter. (We'll revisit this in a later chapter,
...
Try expanding the definitions by substituting equals for equals using a simple
example, like `foldLeft(List(1,2,3), 0)(_ + _)` if this isn't clear.
